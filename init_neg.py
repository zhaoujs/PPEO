...
def init_archive(in_, fitness_):  # in_: 所有粒子位置 fitness_: 所有粒子适应值
    pareto_c = pareto_neg.Pareto_(in_, fitness_)
...
def init_gbest(curr_archiving_in, curr_archiving_fit, mesh_div, min_, max_, particals):
    get_g = archiving_neg.get_gbest(curr_archiving_in, curr_archiving_fit, mesh_div, min_, max_, particals)
