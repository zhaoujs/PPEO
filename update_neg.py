...
def update_archive(in_, fitness_, archive_in, archive_fitness, thresh, mesh_div, min_, max_, particals):
    ...
    pareto_1 = pareto_neg.Pareto_(in_, fitness_)
    ...
    pareto_2 = pareto_neg.Pareto_(in_new, fitness_new)
    ...
    if (curr_archiving_in).shape[0] > thresh:
        clear_ = archiving_neg.clear_archiving(curr_archiving_in, curr_archiving_fit, mesh_div, min_, max_, particals)
...
def update_gbest(archiving_in, archiving_fit, mesh_div, min_, max_, particals):
    get_g = archiving_neg.get_gbest(archiving_in, archiving_fit, mesh_div, min_, max_, particals)
